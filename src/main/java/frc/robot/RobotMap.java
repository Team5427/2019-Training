...
public class RobotMap
{
	 ...
	 */
	public static final double MOTORSPEED_ELEVATOR_UP_AUTO = 1;
	 ...
	 */
	public static final double MOTORSPEED_INTAKE_IN = 0.3;

	/**
	 * The motor speed that correlates to shooting out a box.
	 */
	public static final double MOTORSPEED_INTAKE_OUT = -0.75;

	/**
	 * The motor speed that correlates to shooting a box out slowly.
	 */
	public static final double MOTORSPEED_INTAKE_SLOW = -1.0;

	/**
	 * The motor speed that correlates to moving the climber arm up.
	 */
	public static final double MOTORSPEED_CLIMBERARM_UP = 0.5;

	/**
	 * The motor speed that correlates to moving the climber arm down.
	 */
	public static final double MOTORSPEED_CLIMBERARM_DOWN = -0.3;

	/**
	 * The motor speed that correlates to climbing upward.
	 */
	public static final double MOTORSPEED_CLIMBER_UP = 1.0;

	/**
	 * The motor speed that correlates to descending.
	 */
	public static final double MOTORSPEED_CLIMBER_DOWN = -1.0;

	/**
	 * The motor speed that correlates to tilting the intake upward.
	 */
	public static final double MOTORSPEED_TILTER_UP = 1.0;
